...
function displayRadioValue() {
  return($("input[type='radio'][name='test']:checked").val());
}
function enableChat() {
  document.getElementById("chatEnter").disabled = false;;
...
function enterChat(inp){
  console.log({"station":displayRadioValue(),"userName":fname.value,"msg":msg.value});
